...
const authSlice = createSlice({
  ...
  reducers: {
    ...
    loginFailed: (state) => {
      (state.login.isFetching = false), (state.login.error = true);
    },
    ...
    getProfileFailed: (state) => {
      (state.profile.isFetching = false), (state.profile.error = true);
    },
    ...
    logoutFailed: (state) => {
      (state.logout.isFetching = false), (state.logout.error = true);
    },
  },
});
