            ...
            <main>
                ...
                <div className="row g-5">
                    <div className="col-md-5 col-lg-4 order-md-last">
                        ...
                        <h4 className="mt-4 fw-bold fs-3">Start Price: <span className='text-danger'>{startPrice}</span> vnd</h4>

                        <hr className="my-4" />

                        {/* Bid Area */}
                        <div>
                            <h4 className="mt-4 fs-4">Auction's Increment: <span className='text-danger fst-italic'>{incre}</span> vnd</h4>
                            <form className="needs-validation" noValidate>
                                <div className="row g-3">
                                    <div className="col-md-6 form-floating mt-4">
                                        <div className="form-floating">
